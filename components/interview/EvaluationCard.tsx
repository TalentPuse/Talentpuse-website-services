  ...
  return (
    <div className="bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden">
      ...
      <div className="flex items-center gap-4 p-5 border-b border-slate-100">
        ...
        <div>
          <h4 className="text-sm font-semibold text-slate-900">Kết quả đánh giá</h4>
      ...
      <div className="p-5 space-y-4">
        ...
        <div>
          <div className="flex items-center gap-1.5 mb-2">
            ...
            <span className="text-sm font-semibold text-green-700">Điểm mạnh</span>
          </div>
        ...
        <div>
          <div className="flex items-center gap-1.5 mb-2">
            ...
            <span className="text-sm font-semibold text-amber-700">Cần cải thiện</span>
          </div>
