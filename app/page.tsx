      ...
      <section className="relative border-y border-slate-200 bg-gradient-to-r from-slate-50 via-white to-slate-50">
        <div className="max-w-6xl mx-auto px-6 py-14 grid grid-cols-2 sm:grid-cols-4 gap-8 text-center">
          <ScrollReveal delay={0}>
            ...
            <div className="mt-2 text-sm text-slate-600">{t.stats.sources}</div>
          </ScrollReveal>
          <ScrollReveal delay={0.1}>
            <div className="text-4xl font-bold text-brand-600">
              <AnimatedCounter target={1000} suffix="+" />
            </div>
            <div className="mt-2 text-sm text-slate-600">{t.stats.jobs}</div>
          </ScrollReveal>
          <ScrollReveal delay={0.2}>
            <div className="text-4xl font-bold text-brand-600">24/7</div>
            <div className="mt-2 text-sm text-slate-600">{t.stats.realtime}</div>
          </ScrollReveal>
          <ScrollReveal delay={0.3}>
            <div className="text-4xl font-bold text-brand-600">
              <AnimatedCounter target={4} suffix="+" />
            </div>
            <div className="mt-2 text-sm text-slate-600">{t.stats.channels}</div>
          </ScrollReveal>
        </div>
      </section>
            ...
            <ScrollReveal direction="left">
              <div>
                <div className="inline-flex items-center gap-2 mb-6 px-3 py-1.5 bg-emerald-500/20 border border-emerald-400/30 rounded-full">
                  ...
                  <span className="text-xs font-semibold text-emerald-100">{t.aiAlert.badge}</span>
                </div>
                ...
                <ul className="mt-8 space-y-4">
                  <li className="flex items-start gap-3">
                    ...
                    <span className="text-emerald-50">
                      <strong className="text-white">{t.aiAlert.bullet1Title}</strong>{t.aiAlert.bullet1}
                    </span>
                  </li>
                  <li className="flex items-start gap-3">
                    <span className="mt-0.5 w-6 h-6 rounded-full bg-emerald-500/30 text-emerald-200 flex items-center justify-center flex-shrink-0">
                    ...
                    <span className="text-emerald-50">
                      <strong className="text-white">{t.aiAlert.bullet2Title}</strong>{t.aiAlert.bullet2}
                    </span>
                  </li>
                  <li className="flex items-start gap-3">
                    <span className="mt-0.5 w-6 h-6 rounded-full bg-emerald-500/30 text-emerald-200 flex items-center justify-center flex-shrink-0">
                    ...
                    <span className="text-emerald-50">
                      <strong className="text-white">{t.aiAlert.bullet3Title}</strong>{t.aiAlert.bullet3}
                    </span>
                  </li>
                </ul>
                <Link
              ...
              <div className="relative flex flex-col gap-4 lg:pl-8">
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div className="flex-1">
                      <div className="flex items-center justify-between">
                        <span className="text-xs font-semibold text-emerald-600 bg-emerald-50 px-2 py-0.5 rounded-full">{t.notifications.match} 95%</span>
                        <span className="text-xs text-slate-400">2 {t.notifications.minAgo}</span>
                      </div>
                      <h4 className="mt-1.5 font-semibold text-slate-900 text-sm">Senior React Developer</h4>
                      <p className="text-xs text-slate-500 mt-0.5">FPT Software &middot; Ho Chi Minh</p>
                ...
                >
                  <div className="flex items-start gap-3">
                    ...
                    <div className="flex-1">
                      <div className="flex items-center justify-between">
                        <span className="text-xs font-semibold text-brand-600 bg-brand-50 px-2 py-0.5 rounded-full">{t.notifications.match} 88%</span>
                        <span className="text-xs text-slate-400">15 {t.notifications.minAgo}</span>
                      </div>
                      <h4 className="mt-1.5 font-semibold text-slate-900 text-sm">AI/ML Engineer</h4>
                      <p className="text-xs text-slate-500 mt-0.5">VNG Corporation &middot; Ho Chi Minh</p>
                      <div className="mt-2 flex items-center gap-2">
                ...
                >
                  <div className="flex items-start gap-3">
                    ...
                    <div className="flex-1">
                      <div className="flex items-center justify-between">
                        <span className="text-xs font-semibold text-amber-600 bg-amber-50 px-2 py-0.5 rounded-full">{t.notifications.match} 82%</span>
                        <span className="text-xs text-slate-400">1 {t.notifications.hourAgo}</span>
                      </div>
                      <h4 className="mt-1.5 font-semibold text-slate-900 text-sm">DevOps Engineer</h4>
                      <p className="text-xs text-slate-500 mt-0.5">Tiki &middot; Hanoi</p>
                      <div className="mt-2 flex items-center gap-2">
                ...
                >
                  <span className="text-xs text-emerald-200">{t.aiAlert.sentVia}</span>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 lg:gap-10">
          <ScrollReveal delay={0}>
            <div className="relative bg-white rounded-2xl border border-slate-200 p-8 hover:shadow-xl hover:border-brand-300 transition-all duration-500 hover:-translate-y-1 h-full">
              ...
              <h3 className="text-lg font-semibold text-slate-900 mb-3">{t.howItWorks.step1.title}</h3>
          ...
          <ScrollReveal delay={0.15}>
            <div className="relative bg-white rounded-2xl border border-slate-200 p-8 hover:shadow-xl hover:border-brand-300 transition-all duration-500 hover:-translate-y-1 h-full">
              ...
              <h3 className="text-lg font-semibold text-slate-900 mb-3">{t.howItWorks.step2.title}</h3>
              <p className="text-sm text-slate-600 leading-relaxed">
          ...
          <ScrollReveal delay={0.3}>
            <div className="relative bg-white rounded-2xl border border-slate-200 p-8 hover:shadow-xl hover:border-brand-300 transition-all duration-500 hover:-translate-y-1 h-full">
              ...
              <h3 className="text-lg font-semibold text-slate-900 mb-3">{t.howItWorks.step3.title}</h3>
              <p className="text-sm text-slate-600 leading-relaxed">
