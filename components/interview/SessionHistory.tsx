...
export default function SessionHistory({
  ...
  return (
    <div>
      <h3 className="text-sm font-semibold text-slate-700 mb-3">Lịch sử phiên phỏng vấn</h3>
              ...
              <div className="flex items-center gap-2">
                <span
                  className={`text-[10px] font-medium px-1.5 py-0.5 rounded ${
                    s.mode === "technical" ? "bg-purple-50 text-purple-600" : "bg-teal-50 text-teal-600"
                  }`}
                >
