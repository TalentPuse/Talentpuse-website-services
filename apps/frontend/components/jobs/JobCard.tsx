...
type JobCardProps = {
  ...
  /** Mo panel chi tiet cho job nay. Khong truyen thi vung than card khong the bam. */
  onOpenDetail?: () => void;
};
 ...
 */
export default function JobCard({ job, tracked, onTracked, onOpenDetail }: JobCardProps) {
  ...
  return (
    <GlowCard className="group h-full p-5 transition-all duration-200 ease-out hover:-translate-y-0.5 hover:border-brand-500/40 hover:shadow-lg hover:shadow-brand-900/5">
      {/* Vung than card: bam mo panel chi tiet. CO Y KHONG bao ca CaptureButton /
          link "Xem chi tiet" ben duoi — bam "Da apply" khong duoc mo panel theo. */}
      <div
